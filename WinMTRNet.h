...
// ── Wrapper (formerly WinMTRNetWrapper.h) ───────────────────────────────────
#include <string>
#include <vector>
#include <thread>
#include <atomic>
...
//    WinMTRNetWrapper.h see the same declaration ────────────────────────────
...
{
public:
    explicit WinMTRNetWrapper(IWinMTROptionsProvider* provider)
        : m_provider(provider)
    {}
...
private:
    IWinMTROptionsProvider*    m_provider;
